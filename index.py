...
button_csv_finder = customtkinter.CTkButton(lFrame,text="Select file...", fg_color="transparent", border_width=2, text_color=("gray10", "#DCE4EE"),command=setting_name_of_file)
button_csv_finder.pack(side = "top")



button_start_offers = customtkinter.CTkButton(lFrame,text="Start", fg_color="transparent", border_width=2, text_color=("gray10", "#DCE4EE"),command=startBids)
button_start_offers.pack(side = "top")

appearance_mode_optionemenu = customtkinter.CTkOptionMenu(lFrame,values=["Light", "Dark"],command= change_appearance_mode_event)
...
button_next_offer = customtkinter.CTkButton(finish_bid_selector,text="Siguiente oferta",command=saveOffer,state="disabled")
